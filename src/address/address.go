// Package address contains the types used by ruvmeshnet to represent IPv6 addresses or prefixes, as well as functions for working with these types.
...
// Address represents an IPv6 address in the ruvmeshnet address range.
type Address [16]byte

// Subnet represents an IPv6 /64 subnet in the ruvmeshnet subnet range.
type Subnet [8]byte

// GetPrefix returns the address prefix used by ruvmeshnet.
